...
class TrainOption(BaseOption):
    ...
    def initialize(self, parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        parser.add_argument('--k_fold', type=int, default=2, help='StratifiedKFold（層状K分割）におけるデータの分割数')
        parser.add_argument('--k_fold_random_seed', type=int, default=42, help='StratifiedKFold（層状K分割）におけるrandom seed値')
